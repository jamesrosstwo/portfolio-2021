                ...
                <div className="container">
                    ...
                    <div className="row micro-container">
                        ...
                        <div className="col-xs-12 col-sm-6 micro-item">
                            <img src="https://i.imgur.com/JyxCxmd.png" alt="Float labels"/>
                        </div>
                    </div>
                    ...
                    <div className="row micro-container">
                        <div className="col-xs-12 col-sm-6 col-sm-push-6 micro-item ">
                            ...
                            <p>UBC Bionics is an undergraduate engineering design team at the University of British
                                ...
                                On BEAR, I lead the Analytics team: a small group of six students using information from
                                on-board sensors to improve usability and functionality of the arm. We are
                                <br></br>
